    ...
    if msg.reply_to_message and msg.reply_to_message.document:
        ...
        try:
            ...
            msg.reply_text("An exception occured while restoring your data. The process may not be complete. If "
                           "you're having issues with this, message @fateunion with your backup file so the "
...
__help__ = """
*Admin only:*
 - /import: reply to a saber backup file to import as much as possible, making the transfer super simple! Note \
